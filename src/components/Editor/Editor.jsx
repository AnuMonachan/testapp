...
//     logger.debug(
//       "ObsEditor.js",
//       "In getDetails() for fetching the burrito file of current project"
//     );
...
//   const {
//     state: { obsNavigation, loadData },
//     actions: { setLoadData },
//   } = useContext(ReferenceContext);
//   const updateStory = (story) => {
//     logger.debug(
//       "ObsEditor.js",
//       "In updateStory for upadting the story to the backend md file"
//     );
//     setMdData(story);
//     let title;
//     let body = "";
...
//                 Object.entries(_data.ingredients).forEach(([key]) => {
...
//                   localforage
//                     .getItem("currentProject")
//                     .then(async (projectName) => {
//                       const _projectname = await splitStringByLastOccurance(
//                         projectName,
//                         "_"
//                       );
//                       // const _projectname = projectName?.split('_');
//                       localforage.getItem("projectmeta").then((value) => {
//                         Object.entries(value).forEach(([, _value]) => {
//                           Object.entries(_value).forEach(([, resources]) => {
//                             if (
//                               resources.identification.name.en ===
//                               _projectname[0]
//                             ) {
//                               resources.project[
//                                 resources.type.flavorType.flavor.name
//                               ].navigation = obsNavigation;
//                               resources.project[
//                                 resources.type.flavorType.flavor.name
...
//                   logger.debug(
//                     "ObsEditor.js",
//                     "Reading the md file for selected OBS story"
//                   );
//                   const bookID = obsNavigation?.toString().padStart(2, 0);
...
//                         logger.debug(
//                           "ObsEditor.js",
//                           "Spliting the stories line by line and storing into an array."
//                         );
...
//                             ) {
//                               // Fetching the footer
//                               const objIndex = stories.findIndex(
//                                 (obj) => obj.id === id
//                               );
//                               if (
//                                 objIndex !== -1 &&
...
//                         logger.debug(
//                           "ObsEditor.js",
//                           "Story for selected navigation is been set to the array for Editor"
//                         );
//                         setMdData(stories);
//                       }
//                     });
...
//   return (
//     <Editor callFrom="obs">
//       {mdData && <EditorPanel obsStory={mdData} storyUpdate={updateStory} />}
//     </Editor>
//   );
// };
